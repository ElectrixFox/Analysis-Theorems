...
\end{lemma}
\begin{proof}
    \uses{thm:seq_COLT_add, thm:seq_COLT_scalar_mult}
...
\end{theorem}
\begin{proof}
    \uses{def:seqlimit, lem:seqboundabove_limboundabove, cor:seq_conv_abs_bound}
    To-Do.
\end{proof}
...
\end{theorem}
\begin{proof}
    \uses{def:seqlimit, thm:seq_COLT_mult, thm:seq_COLT_scalar_mult}
    To-Do.
\end{proof}
...
\end{theorem}
\begin{proof}
    \uses{def:seqlimit, thm:seq_COLT_scalar_mult, thm:seq_COLT_mult}
    To-Do.
\end{proof}
